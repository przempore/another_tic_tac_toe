...
use tictactoe::{Action, Actions, Board, BoardWithAction, Cell, Player, Row, State, Terminal};
...
impl TicTacToe {
    ...
    fn possible_actions(&self, board: Board) -> Actions {
    ...
    fn result(&self, mut board: Board, action: Action) -> Board {
    ...
    fn winner(&self, board: Board) -> State {
