...
type Cell_State int32

const (
	Cell_EMPTY Cell_State = 0
	Cell_X     Cell_State = 1
	Cell_O     Cell_State = 2
)

// Enum value maps for Cell_State.
var (
	Cell_State_name = map[int32]string{
		0: "EMPTY",
		1: "X",
		2: "O",
	}
	Cell_State_value = map[string]int32{
		"EMPTY": 0,
		"X":     1,
		"O":     2,
	}
...
func (x Cell_State) Enum() *Cell_State {
	p := new(Cell_State)
	*p = x
	return p
}

func (x Cell_State) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Cell_State) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_tictactoe_proto_enumTypes[0].Descriptor()
}

func (Cell_State) Type() protoreflect.EnumType {
	return &file_proto_tictactoe_proto_enumTypes[0]
}

func (x Cell_State) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Cell_State.Descriptor instead.
func (Cell_State) EnumDescriptor() ([]byte, []int) {
	return file_proto_tictactoe_proto_rawDescGZIP(), []int{2, 0}
}
...
type Cell struct {
	...
	State Cell_State `protobuf:"varint,1,opt,name=state,proto3,enum=tictactoe.Cell_State" json:"state,omitempty"`
}
...
func (x *Cell) GetState() Cell_State {
	if x != nil {
		return x.State
	}
	return Cell_EMPTY
...
var file_proto_tictactoe_proto_rawDesc = []byte{
	...
	,
	...
	0x5f, 0x74, 0x6f, 0x65, 0x2f, 0x6d, 0x61, 0x69, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_proto_tictactoe_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_tictactoe_proto_goTypes = []interface{}{
	(Cell_State)(0),       // 0: tictactoe.Cell.State
	(*Board)(nil),         // 1: tictactoe.Board
	(*Row)(nil),           // 2: tictactoe.Row
	(*Cell)(nil),          // 3: tictactoe.Cell
	(*emptypb.Empty)(nil), // 4: google.protobuf.Empty
}
var file_proto_tictactoe_proto_depIdxs = []int32{
	2, // 0: tictactoe.Board.rows:type_name -> tictactoe.Row
	3, // 1: tictactoe.Row.cells:type_name -> tictactoe.Cell
	0, // 2: tictactoe.Cell.state:type_name -> tictactoe.Cell.State
	4, // 3: tictactoe.TicTacToe.InitialState:input_type -> google.protobuf.Empty
	1, // 4: tictactoe.TicTacToe.InitialState:output_type -> tictactoe.Board
